...
const Login = () => {
  ...
  .catch((error) => {
    ...
    <br/>
    <br/>
    <Button onClick={handlefbIn} variant="contained" color="primary">  FaceBook Sign In</Button>
    <Button onClick = {handlefbOut} variant="contained" color="secondary">FaceBook Sign Out</Button>
    </Container>
    );
};
